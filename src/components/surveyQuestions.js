export const questions = [
	...
	},
	{
		...
		options: [
			...
			{ text: "Sur une autre place en voirie réglementée au nord de la gare", next: "Q3a2" },
			...
			{ text: "Sur une place en voirie réglementée au sud de la gare", next: "Q3a2" },
	...
	},
	{
		...
		options: [
			...
			{ text: "Oui, j'ai un forfait Semaine", next: "Q3a4" },
			{ text: "Non, je paye au prorata de ma durée de stationnement", next: "Q3a4" },
		],
	},
	{
		id: "Q3a2",
		...
		options: [
			{ text: "Oui, pour la zone 3h", next: "Q3a3" },
			{ text: "Oui, pour la zone 1h30", next: "Q3a3" },
			{ text: "Non", next: "Q3a3" },
		],
	},
	{
	...
	},
	{
		...
		options: [
			{ text: "Sur les places arceaux au nord", next: "Q4" },
			{ text: "En consigne au nord", next: "Q4" },
			{ text: "Sur les places arceaux au sud", next: "Q4" },
			{ text: "En consigne au sud", next: "Q4" },
	...
	},
	{
		...
		options: [
			...
			{ text: "Sur une autre place en voirie réglementée au nord de la gare", next: "Q3a2_nv" },
			...
			{ text: "Sur une place en voirie réglementée au sud de la gare", next: "Q3a2_nv" },
	...
	},
	{
		...
		options: [
			...
			{ text: "Oui, j'ai un forfait Semaine", next: "Q3a4_nv" },
			{ text: "Non, je paye au prorata de ma durée de stationnement", next: "Q3a4_nv" },
		],
	},
	{
		id: "Q3a2_nv",
		text: "Disposez-vous d'un macaron résident ?",
		options: [
			{ text: "Oui, pour la zone 3h", next: "Q3a3_nv" },
			{ text: "Oui, pour la zone 1h30", next: "Q3a3_nv" },
	...
	},
	{
		...
		text: "Où avez-vous stationné votre vélo/trottinette ?",
		options: [
			{ text: "Sur les places arceaux au nord", next: "Q8_nv" },
			{ text: "En consigne au nord", next: "Q8_nv" },
			{ text: "Sur les places arceaux au sud", next: "Q8_nv" },
			{ text: "En consigne au sud", next: "Q8_nv" },
